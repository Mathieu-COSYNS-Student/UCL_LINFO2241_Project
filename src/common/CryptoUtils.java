...
public class CryptoUtils {
  ...
  /**
   * This function applies a cryptographic operation (encryption or decryption) to a file and output
   * the result to a an other file
   *
   ...
   */
  private static void cryptographyOnFile(int cipherMode, SecretKey key, File inputFile,
  ...
  /**
   * This function takes as input a password and generates a secret key that can be use for AES
   * encryption. The key is insecure as normally a random salt should be used.
   *
